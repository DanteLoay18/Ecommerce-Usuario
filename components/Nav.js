    ...
    <aside className={(show?'left-0':'-left-full')+" top-0 text-gray-500 p-4 fixed w-full bg-bgGray h-full md:static md:w-auto transition-all"}>
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link href={'/productos'} className={pathname.includes('/productos') ? activeLink : inactiveLink}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={pathname.includes('/productos') ? activeIcon : inactiveIcon}>
        ...
        <Link href={'/categorias'} className={pathname.includes('/categorias') ? activeLink : inactiveLink}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={pathname.includes('/categorias') ? activeIcon : inactiveIcon}>
        ...
        <Link href={'/ordenes'} className={pathname.includes('/ordenes') ? activeLink : inactiveLink}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={pathname.includes('/ordenes') ? activeIcon : inactiveIcon}>
